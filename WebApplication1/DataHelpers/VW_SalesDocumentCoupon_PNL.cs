...
namespace WebApplication1.DataHelpers
{
    ...
    public partial class VW_SalesDocumentCoupon_PNL
    {
        ...
        public Nullable<int> DomesticInternational { get; set; }
        public Nullable<int> OriginCity { get; set; }
        ...
        public Nullable<int> IsOAL { get; set; }
