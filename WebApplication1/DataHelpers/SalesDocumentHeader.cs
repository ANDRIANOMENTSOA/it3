...
namespace WebApplication1.DataHelpers
{
    ...
    public partial class SalesDocumentHeader
    {
        ...
        public SalesDocumentHeader()
        {
            this.SalesRelatedDocumentInformations = new HashSet<SalesRelatedDocumentInformation>();
        }
        ...
        public virtual ICollection<SalesRelatedDocumentInformation> SalesRelatedDocumentInformations { get; set; }
    }
}
